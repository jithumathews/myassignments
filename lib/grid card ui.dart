...
class Grid_with_card extends StatelessWidget {
  ...
  var color = [Colors.blueAccent, Colors.orange, Colors.green,
    Colors.pink, Colors.red, Colors.deepPurple,
    Colors.pink[500],Colors.teal,Colors.orangeAccent,
    Colors.deepOrange, Colors.pinkAccent, Colors.lightGreen];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.builder(
        gridDelegate:
        const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,childAspectRatio: 2, crossAxisSpacing: 20,mainAxisSpacing: 20),
